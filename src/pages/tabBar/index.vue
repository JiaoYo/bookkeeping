<template>
  <view>
    <zhangdan v-if="PageCur == 'zhangdan'"></zhangdan>
    <chart v-if="PageCur == 'chart'"></chart>
    <remember v-if="PageCur == 'remember'"></remember>
    <admin v-if="PageCur == 'admin'"></admin>
...
<script setup>
import zhangdan from '../zhangdan/index.vue'
